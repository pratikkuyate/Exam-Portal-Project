...
<body  style="background-image: linear-gradient(#54109b, #d0549a);">
<div class="header">
<div class="row">
<div class="col-lg-6">
...
echo ' 
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px;"><b style="color:white">Enter Quiz Details</b></span><br /><br />
