...
<div class="col-md-6 panel" style="background-image:linear-gradient(to right, #d0549a , #eee); min-height:430px;">
...
<div class="col-md-10">
<a href="mailto:pratikkuyate987@gmail.com" style="color:#000000">pratikkuyate987@gmail.com</a><br /><br />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<h4 style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Pratik Kuyate</h4>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">72185186581</h4>
